...
LatestExchangeResponseModel latestExchangeResponseModelFromJson(String str) => LatestExchangeResponseModel.fromJson(json.decode(str));

String latestExchangeResponseModelToJson(LatestExchangeResponseModel data) => json.encode(data.toJson());
...
class LatestExchangeResponseModel {
  ...
  factory LatestExchangeResponseModel.fromJson(Map<String, dynamic> json) => LatestExchangeResponseModel(
        remark: json["remark"],
        status: json["status"],
...
class Exchanges {
  ...
  factory Exchanges.fromJson(Map<String, dynamic> json) => Exchanges(
        data: json["data"] == null ? [] : List<LatestExchange>.from(json["data"]!.map((x) => LatestExchange.fromJson(x))),
