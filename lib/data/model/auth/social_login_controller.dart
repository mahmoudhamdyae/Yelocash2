...
import 'package:changa_lab/view/packages/signin_with_linkdin/signin_with_linkedin.dart';
    ...
    try {
      ...
      if (responseModel.statusCode == 200) {
        ...
        if (loginModel.status.toString().toLowerCase() == MyStrings.success.toLowerCase()) {
          ...
          await RouteMiddleWare.checkUserStatusAndGoToNextStep(user: user, accessToken: accessToken, tokenType: tokenType);
        } else {
