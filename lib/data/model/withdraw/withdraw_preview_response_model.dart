...
WithdrawNowModel withdrawNowModelFromJson(String str) =>
    WithdrawNowModel.fromJson(json.decode(str));

String withdrawNowModelToJson(WithdrawNowModel data) =>
...
class Method {
  ...
  factory Method.fromJson(Map<String, dynamic> json) => Method(
        ...
        userDetailFormId: json["user_detail_form_id"] !=null? json["user_detail_form_id"].toString() : '',
        ...
        trxProofFormId: json["trx_proof_form_id"] !=null? json["trx_proof_form_id"].toString() : '',
