...
import 'package:changa_lab/view/components/circle_button_with_icon.dart';
import 'package:changa_lab/view/components/column_widget/card_column.dart';
import 'package:changa_lab/view/components/image/circle_shape_image.dart';
      ...
      builder: (controller) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                const CircleShapeImage(imageColor: MyColor.primaryColor,image: MyImages.email,isSvgImage: true,),
                const SizedBox(width: Dimensions.space15),
