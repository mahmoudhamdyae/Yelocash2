...
import 'package:changa_lab/view/screen/deposits/widget/custom_deposits_card.dart';
import 'package:changa_lab/view/screen/deposits/widget/deposit_bottom_sheet.dart';
import 'package:changa_lab/view/screen/deposits/widget/deposit_history_top.dart';
            ...
            body: controller.isLoading ? const CustomLoader() : Padding(
              ...
              child: Column(
                children: [
                  ...
                  Expanded(
                    child: controller.depositList.isEmpty && controller.searchLoading == false ? const NoDataOrInternetScreen(/*title:MyStrings.noDepositFound,height:controller.isSearch?0.75:0.8*/) :
